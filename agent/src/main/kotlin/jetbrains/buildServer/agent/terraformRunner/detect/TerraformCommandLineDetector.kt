...
class TerraformCommandLineDetector : TerraformDetector {
    ...
    override fun detectTerraformInstances(buildAgentConfiguration: BuildAgentConfiguration): MutableMap<String, TerraformInstance> {
        val instances = HashMap<String, TerraformInstance>()
    ...
    private fun getSearchPaths(buildAgentConfiguration: BuildAgentConfiguration): MutableList<SearchPath> {
        val searchPath = buildAgentConfiguration.configurationParameters[CommonConst.BUILD_PARAM_SEARCH_PATH]
    ...
    companion object {
        ...
        fun parseTerraformInstance(
            instances: HashMap<String, TerraformInstance>,
            ...
            instances[version] = TerraformInstance(
                version,
                detectionPath.path,
